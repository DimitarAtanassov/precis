...
from modelo_kit.cli.menu import OBSIDIAN_MENU
from modelo_kit.cli.prompts import (
    confirm,
    print_error,
    print_header,
    print_section,
...
from modelo_kit.core.filename_utils import get_name_from_source
from modelo_kit.core.output import OutputWriter, ParsedPaperData
