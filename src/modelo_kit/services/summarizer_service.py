...
from modelo_kit.models.summary_model import SectionSummary, PaperSummary
...
class SummarizerConfig:
    ...
    @classmethod
    def for_model(cls, model_name: str, **kwargs) -> "SummarizerConfig":
    ...
    def _summarize_section(
        ...
        if content_tokens <= self.config.max_chunk_tokens:
            return self._summarize_content(
                paper_title, section, content, context
            )
        
        return self._summarize_long_section(
            paper_title, section, content, context
        )
